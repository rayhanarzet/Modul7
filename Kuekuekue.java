...
public class Kuekuekue { // Main Classs
 ...
 //buat array dengan gabungan objek KuePesanan dan KueJadi
        ...
        kueArray[2] = new KuePesanan("Tiramisu", 45000, 0.8);
        kueArray[3] = new KueJadi("Blackforest", 3000, 20);
        kueArray[4] = new KuePesanan("Cheesecake", 60000, 1.0);
        kueArray[5] = new KueJadi("Red Velvet", 4000, 15);
        kueArray[6] = new KuePesanan("Cookies & Cream", 80000, 0.5);
        kueArray[7] = new KueJadi("Shortcake", 3500, 12);
        kueArray[8] = new KuePesanan("Buttercake", 55000, 0.7);
        kueArray[9] = new KueJadi("Fruit Pie", 7000, 8);
        kueArray[10] = new KuePesanan("Pudding", 30000, 1.5);
        kueArray[11] = new KueJadi("Cupcake", 8000, 6);
        kueArray[12] = new KuePesanan("Tart", 100000, 0.9);
        kueArray[13] = new KueJadi("Cookies", 2500, 18);
        kueArray[14] = new KuePesanan("Muffin", 75000, 1.1);
        kueArray[15] = new KueJadi("Macarons", 4000, 10);
        kueArray[16] = new KuePesanan("Ice Cream Cake", 35000, 2.0);
        kueArray[17] = new KueJadi("Chocolate Lava", 5000, 7);
        kueArray[18] = new KuePesanan("Carrot Cake", 20000, 2.5);
        kueArray[19] = new KueJadi("Strawberry Cheesecake", 3000, 15);
